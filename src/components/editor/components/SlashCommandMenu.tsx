...
>(function SlashCommandMenu(
	...
	return createPortal(
		<div
			...
			className="fixed z-50 w-64 max-h-80 overflow-y-auto rounded-xl border border-border bg-surface/95 backdrop-blur-md shadow-2xl p-1 text-foreground transition-all duration-150 animate-in fade-in zoom-in-95"
		>
			<div className="px-2.5 py-1.5 text-[11px] font-medium text-muted/70 tracking-wider">
				快捷命令 · 输入筛选
			</div>
