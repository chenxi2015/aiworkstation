...
export function FloatingChatButton({ onOpenChat }: FloatingChatButtonProps) {
	return (
		...
		>
			<BotMessageSquare className="w-4 h-4 group-hover:rotate-12 transition-transform" />
			<span>Chat with Bookmarks</span>
			<span className="px-1.5 py-0.2 text-[9px] rounded-full bg-background/20 font-mono font-bold">
				AI
			</span>
		</button>
	);
