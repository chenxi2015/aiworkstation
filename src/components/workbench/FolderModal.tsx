...
interface FolderModalProps {
  ...
  onClose: () => void;
  onSave: (data: { id?: number; name: string; category: string; desc: string }) => void;
    ...
    >
      <div className="w-full max-w-md bg-[var(--surface,oklch(1_0_0))] rounded-3xl border border-[var(--border,oklch(0.9_0.004_286.32))] shadow-2xl p-7 animate-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Name Field */}
          <div>
            <label className="block text-xs font-semibold text-[var(--foreground,oklch(0.21_0.006_285.89))] mb-1.5">
              文件夹名称 <span className="text-[var(--danger,oklch(0.65_0.23_25.74))]">*</span>
            </label>
            <input
              type="text"
              value={name}
