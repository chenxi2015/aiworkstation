      ...
      >
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={onStartGrab}
            className={`relative flex-1 h-10 px-3 sm:px-4 rounded-full flex items-center justify-center gap-2 font-medium text-xs sm:text-sm transition-all duration-200 select-none group cursor-pointer active:scale-[0.99] shadow-sm hover:shadow-md min-w-0 ${
              isGrabbing
